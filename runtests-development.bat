...
%OPENCOVER_BIN% -target:%NUNIT_RUNNER% -targetdir:%APP_BIN_DIR% -targetargs:"/nologo /noshadow %FOUND_DLLS%" -register -output:%OPENCOVER_OUTPUT_FILE%
%RESHARPER_BIN% /o:%RESHARPER_OUTPUT_FILE% NHS111/NHS111.sln